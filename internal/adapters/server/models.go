...
type Account struct {
	ID             string    `json:"id" example:"018ef16a-31a7-7e11-a77d-78b2eea91e2f" doc:"Account ID"`
...
type Transaction struct {
	ID            string    `json:"id" example:"0124e053-3580-7000-ba62-25ac616ac7f4" doc:"Transaction ID"`
